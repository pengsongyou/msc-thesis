...
\begin{equation*}
    ...
    \qquad
    \raisebox{-0.7cm}{\includegraphics[height=0.1\textwidth]{figures/result/light9.pdf}}
\end{equation*}
...
To explain the reason that our method is working, we first assume that 10 input color images are given.
