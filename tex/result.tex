...
%\begin{figure}[!ht]
%\centering
%\subfigure[Input depth]{\label{fig:result_input_depth}\includegraphics[width=0.13\linewidth]{figures/result/comp_input_shape.pdf}}
%\qquad \qquad
%\subfigure[Ground truth depth]{\label{fig:result_input_depth2}\includegraphics[width=0.13\linewidth]{figures/result/comp_gt_shape.pdf}}
