...
{Input depth} & {After pre-processing} & {Refined depth}
 \end{tabular}}
\caption{Illustrations for our proposed robust multi-light method. Here $10$ images with various lighting conditions have been used, one of which is the top left RGB image.}
...
The whole process follows our robust multi-light model method described in Alg.~\ref{alg:robust}.
