...
\item The most important inspiration is, as we noticed from experiments, the fixed-point method works fast and well but the convergence is a problem. 
...
Therefore, we thought of the idea of RGB ratio model.
...
And to fully use the information of the RGB three channels and eliminate the non-linearity in the objective function in the depth refinement, we use the ratio model between every two channels among the three.
R and G channel is used as an example of our ratio model:
...
%----------------------------------------------
\subsection{Limitations for previous method}
%----------------------------------------------
\begin{itemize}
