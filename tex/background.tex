...
Due to the fact that sun is a source of infrared light, the use of these cameras is limited to the indoor environment.
...
\subfigure[RGB image]{\includegraphics[width=0.4\linewidth]{figures/scene_rgb.pdf}}
...
Yu \emph{et al.}~\cite{yu2013shading} iteratively updated SH lighting and the albedo using the initial depth and the refined the shape with the estimated lighting and the relative albedo. 
